...
              <div class="card">
                <div class="card-body">
				  <h2><b>List rekomendasi drama korea yang ceritanya ringan untuk pemula</b></h2>
                  <a href="{{ url('artikel/create') }}" class="btn btn-md btn-success mb-3">TAMBAH DAFTAR DRAMA KOREA</a>
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th scope="col">FOTO</th>
                        <th scope="col">JUDUL DRAKOR</th>
...
                      Data drama korea belum Tersedia.
                    </div>
                    @endforelse
                  </tbody>
                </table>
