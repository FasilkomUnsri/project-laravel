        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="#slide" class="nav-link px-2 text-white">Home</a></li>
        ...
        <section class="text-center container-full" id="slider">
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-item">
                        <img src="images/slide/bg2.jpg">
                                            
                <div class="container">
                    <div class="carousel-caption">
                       <h1>Keras Bagaikan Batu Karang | @letryy21 </h1>
        ...
        <section id="about_us" class="py-5 px-5">
            <div class="row">
             <div class="col-md-10 order-md-2">
                <h2>Haii, Saya <span class="text-muted">Leli Triani</span></h2>
                <p class="lead">Saya adalah mahasiswa Jurusan Komputerisasi Akuntansi 2020 dari Fakultas Ilmu Komputer Universitas Sriwijaya. Sekarang saya masih kuliah semester 3. Rencana saya setelah lulus kuliah, saya ingin kerja di <b>E-Commerce Shopee</b></b> </p>

                <h5>Biodata & Riwayat Akademis</h5>
                <ul>
                    <li>Leli Triani | lelitriani992@gmail.com</li>
                    <li>SD Negeri 2 Serigeni</li>
                    <li>SMP Negeri 4 Kayuagung</li>
                    <li>SMA Negeri 2 Kayuagung</li>
                    <li>Universitas Sriwijaya</li>
                </ul>
             </div>
             <div class="col-md-2 order-md-1">
                 <img src="images/slide/leli.jpeg" class="img-fluid">
             </div> 
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a class="d-inline-flex align-items-center mb-2 link-warning text-decoration-none"
                        href="/" aria-label="FASILKOM UNSRI">
                        <img src="images/slide/logo.jpg" height="50">
