...
<body>
	...
	<div class="medsos">
		<div class="container">
			<ul>
				...
				<li><a href="https://www.instagram.com/adeliaaprt"><i class="fab fa-instagram"></i></a></li>
	...
	<header>
		<div class="container">
		<h1><a href="index.html"></a>Adelia Ayu Pratiwi</h1>
		<ul>
			<li class="active"><a href="index.html"><i class="fas fa-home"></i></a></li>
			<li><a href="about.html"><i class="fas fa-list"></i></a></li>
			<li><a href="contact.html"><i class="fas fa-id-card-alt"></i></a></li>
		</ul>
		</div>
	</header>
	...
	<footer>
		<div class="container">
			<small> Copyright &copy; 2021 - Adelia Ayu Pratiwi, All Rights Reserved.</small>
		</div>
	</footer>
