...
<nav class="navbar  fixed-top navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
  <a class="navbar-brand" href="#">Andana Rishel Nathanio</a>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-center">
    ...
    <h1 class="display-4">Andana Rishel Nathanio</h1>
    <p class="lead">komputerisasi akuntansi | ilmu komputer | universitas sriwijaya</p>
  </div>
</div>
...
<div class="container">
  ...
  <div class="row justify-content-center ">
    <div class="col-md-5 text-center">
      <p>Nama          : Andana Rishel nathanio</p>
      <p>Umur          : 19 Tahun</p>
      <p>Jenis Kelamin : Laki-laki</p>
      <p>Kelas         : Ka 3A</p>
      <p>NIM           : 09020582024043</p>
  ...
  <div class="row mb-4">
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">PLAYERUNKNOWN'S BATTLEGROUNDS MOBILE</p>
        </div>
      </div>
    </div>
     <div class="col-md">
    ...
    <div class="col-md">
     ...
     <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">SUBWAY SURFERS</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-4">
      ...
      <ul class="list-group">
          ...
          <li class="list-group-item">jl.DRS Dahlan Hy</li>
