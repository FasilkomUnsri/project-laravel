...
              <div class="card">
                <div class="card-body">
                  <a href="{{ url('mahasiswa/create') }}" class="btn btn-md btn-success mb-3">TAMBAH MAHASISWA</a>
...
                        <img src="{{ Storage::url('public/mahasiswa/').$mahasiswa->gambar }}" class="rounded" style="width: 150px">
                      </td>
