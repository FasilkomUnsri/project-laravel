                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-start">
                                <h1>Reminder - Indah Fatimah Azzahra  </h1>
                                <p> Kalo kamu males-malesan inget diluar sana banyak orang seumuran kamu,yang lagi kerja keras biar masa depan mereka cerah.Cape itu wajar,tapi nyerah bukan jalan keluar</p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <h1>Motivasi | Indah Fatimah Azzahra</h1>
                                <p>Gagal itu urusan nanti yang terpenting kita berani untuk mencoba dan mencoba</p>
                                <p><a class="btn btn-lg btn-primary" href="#">Read More</a></p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="about_us" class="py-5 px-5">
            <div class="row ">
                <div class="col-md-10 order-md-2">
                    <h2>Halo, Saya <span class="text-muted">Indah Fatimah Azzahra</span></h2>
                    ...
                    <ul>
                        <li>Indah Fatimah Azzahra | indahfatimahh25@gmail.com</li>
                        <li>SD Negeri 44 Prabumulih</li>
                        <li>SMP Negeri 01 Prabumulih</li>
                        <li>SMA Negeri 3 Prabumulih</li>
                        <li>Universitas Sriwijaya Palembang</li>
                    </ul>
                </div>
                <div class="col-md-2 order-md-1">
                    <img src="images/profile/indahcantik.jpeg" class="img-fluid">
                </div>
            </div>
        </section>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a class="d-inline-flex align-items-center mb-2 link-warning text-decoration-none" href="/" aria-label="FASILKOM UNSRI">
                        <img src="images/logo/1.jpg" height="50">
