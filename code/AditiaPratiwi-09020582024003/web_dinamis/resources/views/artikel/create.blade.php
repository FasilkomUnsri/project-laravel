...
                                <div class="form-group">
    ...
                                        <input type="text" class="form-control @error('IDbuku') is-invalid @enderror" name="IDbuku" value="{{ old('IDbuku') }}" placeholder="Masukkan ID Buku">
                                        @error('IDbuku')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
    ...
                                    <div class="form-group">
        ...
                                            <input type="text" class="form-control @error('penerbit') is-invalid @enderror" name="penerbit" value="{{ old('penerbit') }}" placeholder="Masukkan Penerbit (Tahun terbit)">
                                            @error('penerbit')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
...
                                    <label class="font-weight-bold">Isi Buku</label>
