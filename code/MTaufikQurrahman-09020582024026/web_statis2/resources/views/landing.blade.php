                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-start">
                                <h1>Belajar - M Taufik Qurrahman</h1>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <h1>Pengetahuan | M Taufik Qurrahman</h1>
        ...
        <section id="about_us" class="py-5 px-5">
            <div class="row ">
                <div class="col-md-10 order-md-2">
                    <h2>Halo, Saya <span class="text-muted">M Taufik Qurrahman</span></h2>
                    ...
                    <ul>
                        ...
                        <li>SMA Methodist 7 Palembang</li>
                        <li>Universitas Sriwijaya Palembang</li>
                    </ul>
                </div>
                <div class="col-md-2 order-md-1">
                    <img src="images/about/foto.png" class="img-fluid">
                </div>
            </div>
        </section>
