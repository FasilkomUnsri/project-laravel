            ...
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="images/slide/gambar2.png">
                        <div class="container">
                            <div class="carousel-caption">
                                <h1>life | Ratih Indri</h1>
                                <p>RIDE OR DIE</p>
                                <p><a class="btn btn-lg btn-primary" href="#">Read More</a></p>
                            </div>
                        </div>
        ...
        <section id="about_us" class="py-5 px-5">
            <div class="row ">
                <div class="col-md-10 order-md-2">
                    <h2>Halo, Saya <span class="text-muted">Ratih Indri Hapsari</span></h2>
                    <p class="lead">Jurusan Komputerisasi Akuntansi 2020 dari Fakultas Ilmu Komputer Universitas Sriwijaya.</p>
                    <h5>Biodata & Riwayat Akademis</h5>
                    <ul>
                        <li>Ratih Indri Hapsari | Ratih Indri Hapsari54@gmail.com</li>
                        <li>SD Negeri 18 Palembang</li>
                        <li>SMP Negeri 3 Palembang</li>
                        <li>SMA Islam Az Zahra Palembang</li>
