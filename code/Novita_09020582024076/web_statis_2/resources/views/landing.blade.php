            ...
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/slide/a.jpeg">           
                        <div class="container">
                            <div class="carousel-caption text-start">
                                <h1>Belajar - Novita</h1>
                                <p>Darinya, aku mengambil filosofi bahwa belajar adalah sikap berani menantang segala ketidakmungkinan; bahwa ilmu yang tak dikuasai akan menjelma di dalam diri manusia menjadi sebuah ketakutan. ...</p>
                                <p><a class="btn btn-lg btn-primary" href="#">Read More</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="images/slide/b.jpeg">
                        <div class="container">
                            <div class="carousel-caption">
                                <h1>Pengetahuan | Novita</h1>
                                <p>Dari semua hal, pengetahuan adalah yang paling baik, karena tidak kena tanggung jawab maupun tidak dapat dicuri, karena tidak dapat dibeli, dan tidak dapat dihancurkan.</p>
                                <p><a class="btn btn-lg btn-primary" href="#">Read More</a></p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="about_us" class="py-5 px-5">
            <div class="row ">
                <div class="col-md-10 order-md-2">
                    <h2>Halo, Saya <span class="text-muted">Novita</span></h2>
                    ...
                    <ul>
                        <li>Novita | nta13456@gmail.com</li>
                        <li>SD Negeri 5 Talang Kelapa</li>
                        <li>SMP Bakti Ibu 2 Palembang</li>
                        <li>SMA Bakti Ibu 3 Palembang</li>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a class="d-inline-flex align-items-center mb-2 link-warning text-decoration-none" href="/" aria-label="FASILKOM UNSRI">
                        <img src="images/slide/logo.jpeg" height="50">
