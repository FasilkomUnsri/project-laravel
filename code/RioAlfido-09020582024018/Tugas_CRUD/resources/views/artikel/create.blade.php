	 	 	 	 	 	 	 	 	 	 ...
	 	 	 	 	 	 	 	 	 	 <div class="card border">
	 	 	 	 	 	 	 	 	 	 	 	 <div class="card-body">
																	  ...
																	  <div class="form-group">
																		...
																		<input type="text" class="form-control @error('prodi') is-invalid @enderror" name="prodi" value="{{ old('prodi') }}" placeholder="Masukkan prodi Mahasiswa">
																			@error('prodi')
																		<div class="alert alert-danger mt-2">
																				  {{ $message }}
																		</div>
...
<script src="../ckeditor/ckeditor.js"></script>
	<script>
	 	 	ClassicEditor
	 	 	 	 	 	 .create( document.querySelector( 'diisi jika ingin menggunakan ckeditor menggunkan class id' ) )
	 	 	 	 	 	 .catch( error => {
	 	 	 	 	 	 	 	 console.error( error );
	 	 	 	 	 	 } );
</script>
